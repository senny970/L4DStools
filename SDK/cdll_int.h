...
// For non-split screen games this will always be zero
	...
	virtual void TracePaintSurface( const model_t *model, const Vector& position, float radius, Color& surfColors ) = 0;
...
{
public:
	virtual void GetCurrentRecordingEntity() = 0;
	virtual void PostToolMessage( void* hEntity, void *pMsg ) = 0;
};
