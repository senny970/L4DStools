...
public:
	...
	inline void SetMouseInputEnabledfix(VPANEL vguiPanel, bool state) {
		return GetVirtualFunction<void(__thiscall*)(IPanel*, VPANEL, bool)>(this, 41)(this, vguiPanel, state);
	}
	...
	virtual int &GetChildren( VPANEL vguiPanel ) = 0;
...
// sibling pins
	virtual void SetSiblingPin(VPANEL vguiPanel, VPANEL newSibling, bool iMyCornerToPin = 0, bool iSiblingCornerToPinTo = 0 ) = 0;	
};
